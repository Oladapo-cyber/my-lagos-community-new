      ...
      <div className="w-full bg-white">
        <div className="container mx-auto ">
            <div className="flex flex-col lg:flex-row bg-white shadow-xl overflow-hidden border border-gray-100">
                ...
                <div className="hidden lg:flex absolute right-0 top-0 bottom-0 w-12 bg-[#222] text-white items-center justify-center z-10">
                    <span 
                        style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }} 
                        className="uppercase tracking-[0.2em] font-bold text-2xl"
                    >
                        Registration
                    </span>
                </div>
                    ...
                    <div className="pr-8">
                        ...
                        <div className="flex items-center justify-between">
                            <button
                                onClick={() => navigate(`/events/${eventId}/select-ticket`)}
                                className="bg-[#1976D2] hover:bg-blue-700 text-white px-8 py-3 font-bold text-xs uppercase transition-colors shadow-sm rounded-sm"
                            >
                                BUY TICKET
                            </button>
