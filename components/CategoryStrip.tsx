...
export const CategoryStrip: React.FC = () => {
  return (
    <div className="bg-white border-b border-gray-100 shadow-sm relative z-20 -mt-6 sm:-mt-8 mx-auto max-w-7xl rounded-xl px-2 sm:px-4">
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 items-start py-6 gap-y-6">
        {CATEGORIES.map((cat, idx) => (
          <div key={idx} className="flex flex-col items-center group cursor-pointer p-2 transition-transform hover:-translate-y-1">
